...
-- * Rank_number - строки ранжированы по возрастанию, но нет номера 3.
-- Вместо этого, 2 строки делят номер 2, а за ними сразу идет номер 4.
-- * Dense_rank - то же самое, что и rank_number, но номер 3 не пропущен.
-- Номера идет подряд, но зато нитко не оказался пятым из пяти.

Country partiticaped row_number rank_number dense_rank
GBR     27           1          1           1
DEN     26           2          2           2
FRA     26           3          2           2
ITA     25           4          4           3
